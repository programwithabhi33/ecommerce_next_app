...
const product = ({buyNow,addToCart,mainProduct,colorSizeArray}) => {
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mx-auto">
                ...
                <button onClick={()=>{buyNow(product.slug,product.title,product.quantity,59000,product.size,product.color)}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
